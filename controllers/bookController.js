...
exports.index = function(req, res) {
    async.parallel({
        book_count: function(callback) {
            Book.countDocuments({}, callback); //Pass an empy object as a match condition to find all documents of this collections
        },
...
exports.book_update_get = function(req, res, next) {
    ...
    async.parallel({
        ...
        genres: function(callback) {
            ...
            res.render('book_form', { title: 'Updated Book', authors: results.authors, genres: results.genres, book: results.book});
    });
};
